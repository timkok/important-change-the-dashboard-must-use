...
POSITIVE_TERMS = ["approval", "approved", "benefit", "effective", "breakthrough", "growth", "strong sales", "positive trial", "reduced risk", "successful"]
NEGATIVE_TERMS = ["lawsuit", "shortage", "adverse event", "side effect", "risk", "warning", "death", "denied coverage", "backlash", "safety concern"]
...
TRADE_DOMAINS = {"biopharmadive.com", "fiercepharma.com", "pharmavoice.com", "endpoints.news", "pharmaceutical-technology.com", "evaluate.com", "fiercebiotech.com", "fiercepharma.com"}
FINANCE_DOMAINS = {"marketwatch.com", "investors.com", "barrons.com", "finance.yahoo.com", "seekingalpha.com", "fool.com"}
